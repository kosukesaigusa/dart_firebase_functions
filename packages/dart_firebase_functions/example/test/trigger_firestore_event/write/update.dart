...
void main() {
  test('trigger google.cloud.firestore.document.v1.written (update)', () async {
    await http.post(
      ...
      headers: {
        ...
        'forwarded': 'for="107.178.225.131";proto=https',
        'traceparent':
            '00-a4926a4076cf9d430ce8c32ce936f6e5-0c6ca64da34b7fc4-01',
        'content-length': '1167',
        'ce-source':
        ...
        'x-cloud-trace-context':
            'a4926a4076cf9d430ce8c32ce936f6e5/895273278322212804;o=1',
        'user-agent':
        ...
        'x-forwarded-for': '107.178.225.131',
...
final updateOnWrittenDocumentEventData = {
  'value': {
    'name':
...
final _protobufBytesWhenUpdatingDocument =
    Uint8List.fromList(_bytesWhenUpdatingOnWrittenDocument);

/// A record in json when updating todo document.
final _bytesWhenUpdatingOnWrittenDocument = [
  10,
  144,
  4,
  10,
