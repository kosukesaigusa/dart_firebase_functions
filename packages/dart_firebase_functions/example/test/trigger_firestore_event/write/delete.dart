...
void main() {
  test('trigger google.cloud.firestore.document.v1.written (delete)', () async {
    await http.post(
      Uri.parse('http://localhost:8080/'),
      body: _protobufBytesWhenDeletingOnWrittenDocument,
      headers: {
        'ce-dataschema':
        ...
        'forwarded': 'for="107.178.225.98";proto=https',
        'traceparent':
            '00-511e13890f59a17b5908bd7cc01ecd29-6adeac3f6b94871b-01',
        'content-length': '485',
        'ce-source':
        ...
        'x-cloud-trace-context':
            '511e13890f59a17b5908bd7cc01ecd29/7700781801237939995;o=1',
        'user-agent':
        ...
        'x-forwarded-for': '107.178.225.98',
...
final deleteOnWrittenDocumentEventData = {
  'oldValue': {
    'name':
...
final _protobufBytesWhenDeletingOnWrittenDocument =
    Uint8List.fromList(_bytesWhenDeletingOnWrittenDocument);

/// A record in json when deleting todo document.
final _bytesWhenDeletingOnWrittenDocument = [
  18,
  226,
  3,
  10,
